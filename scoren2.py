...
#mnist1
attm1 = [[0.4698,0.6601],[0.6724,0.5420]]
feam1 = [[0.9316,0.7755],[0.7509,0.9165]]
ascorem1 = [[0.4698,0.6601],[0.6724,0.5420]]

#mnist2
attm2 = [[0.5990,0.8031],[0.8865,0.7493]]
feam2 = [[0.9244,0.8536],[0.7767,0.9504]]
ascorem2 = [[0.5990,0.8031],[0.8865,0.7493]]

#cifar
attc = [[0.6383,0.6153],[0.6397,0.6210]]
feac = [[0.7154,0.7283],[0.6829,0.6923]]
ascorec = [[0.6383,0.6153],[0.6397,0.6210]]
